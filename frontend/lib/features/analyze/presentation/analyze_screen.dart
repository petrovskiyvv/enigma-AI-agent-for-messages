...
class _AnalyzeScreenState extends State<AnalyzeScreen> {
  ...
  // Мобилка: вертикальный скролл — ввод сверху, результат снизу
  Widget _buildMobile(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildInput(context, mobile: true),
  ...
  Widget _buildInput(BuildContext context, {bool mobile = false}) {
    final colors = context.colors;
    return Padding(
      padding: EdgeInsets.all(mobile ? 0 : 24),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Текст письма',
          ...
          : _result == null
              ? Center(
                  child: Padding(
                    ...
                    child: Text('Результат появится здесь',
      ...
      children: [
        ...
        if (t.aiResponse.isNotEmpty) ...[
          ...
          Container(
            ...
            child: SelectableText(t.aiResponse,
                style: TextStyle(color: colors.text, fontSize: 13, height: 1.7)),
          ),
        ],
      ],
